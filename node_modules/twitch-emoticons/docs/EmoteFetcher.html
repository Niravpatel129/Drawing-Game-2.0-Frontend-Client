...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="struct_EmoteFetcher.js.html">struct/EmoteFetcher.js</a>, <a href="struct_EmoteFetcher.js.html#line13">line 13</a>
    </li></ul></dd>
...
<div class="description">
    <p>Cached channels.<br>Collectionped by name to Channel instance.</p>
</div>
...
<div class="description">
    <p>Cached emotes.<br>Collectionped by emote code to Emote instance.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="struct_EmoteFetcher.js.html">struct/EmoteFetcher.js</a>, <a href="struct_EmoteFetcher.js.html#line89">line 89</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="struct_EmoteFetcher.js.html">struct/EmoteFetcher.js</a>, <a href="struct_EmoteFetcher.js.html#line127">line 127</a>
    </li></ul></dd>
...
<span class="param-type"><a href="FFZEmote.html">FFZEmote</a></span>
    ...
    <h4 class="name" id="_cacheTwitchEmote"><span class="type-signature">(private) </span>_cacheTwitchEmote<span class="signature">(id, data)</span><span class="type-signature"> &rarr; {<a href="TwitchEmote.html">TwitchEmote</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="struct_EmoteFetcher.js.html">struct/EmoteFetcher.js</a>, <a href="struct_EmoteFetcher.js.html#line54">line 54</a>
    </li></ul></dd>
...
<span class="param-type"><a href="TwitchEmote.html">TwitchEmote</a></span>
    ...
    <h4 class="name" id="_getRawBTTVEmotes"><span class="type-signature">(private) </span>_getRawBTTVEmotes<span class="signature">(name)</span><span class="type-signature"> &rarr; {Promise.&lt;Array.&lt;Object>>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="struct_EmoteFetcher.js.html">struct/EmoteFetcher.js</a>, <a href="struct_EmoteFetcher.js.html#line74">line 74</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the raw BTTV emotes data for a channel.</p>
</div>
...
<span class="param-type">Promise.&lt;Array.&lt;Object>></span>
    ...
    <h4 class="name" id="_getRawFFZEmotes"><span class="type-signature">(private) </span>_getRawFFZEmotes<span class="signature">(name)</span><span class="type-signature"> &rarr; {Promise.&lt;Array.&lt;Object>>}</span></h4>
...
<span class="param-type">Promise.&lt;Array.&lt;Object>></span>
    ...
    <h4 class="name" id="_getRawTwitchEmotes"><span class="type-signature">(private) </span>_getRawTwitchEmotes<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;Object>}</span></h4>
...
<div class="description">
    <p>Gets the raw twitch emotes data.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="struct_EmoteFetcher.js.html">struct/EmoteFetcher.js</a>, <a href="struct_EmoteFetcher.js.html#line167">line 167</a>
    </li></ul></dd>
...
<div class="description">
    <p>Fetches the BTTV emotes for a channel.<br>Use <code>null</code> for the global emotes channel.</p>
</div>
...
<span class="param-type">Promise.&lt;<a href="Collection.html">Collection</a>.&lt;string, <a href="FFZEmote.html">FFZEmote</a>>></span>
    ...
    <h4 class="name" id="fetchTwitchEmotes"><span class="type-signature"></span>fetchTwitchEmotes<span class="signature">(names<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="Collection.html">Collection</a>.&lt;string, <a href="TwitchEmote.html">TwitchEmote</a>>>}</span></h4>
...
<div class="description">
    <p>Fetches and caches all twitch emotes.<br>If channel names are specified, will only cache those channels.<br>Use <code>null</code> for the global emotes channel.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
            ...
            <td class="description last"><p>Names of channels to cache.</p></td>
        </tr>
