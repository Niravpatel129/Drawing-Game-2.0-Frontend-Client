...
<div id="main">
    ...
    <section class="readme">
        <article><h1>twitch-emoticons</h1><p>Get a Twitch channel's Twitch emotes, BTTV emotes, and FFZ emotes!</p>
<h3>Example</h3><pre class="prettyprint source lang-js"><code>const { EmoteFetcher, EmoteParser } = require('twitch-emoticons');
...
});</code></pre><h3>Links</h3><ul>
<li><a href="https://github.com/1Computer1/twitch-emoticons">Github</a></li>
<li><a href="https://1computer1.github.io/twitch-emoticons/">Documentation</a></li>
<li><a href="https://github.com/1Computer1/twitch-emoticons/releases">Changelog</a></li>
</ul>
<p>This library uses the following:  </p>
<ul>
<li><a href="https://twitchemotes.com/apidocs">Twitch Emotes API</a></li>
<li><a href="https://api.betterttv.net/">BetterTTV API</a></li>
