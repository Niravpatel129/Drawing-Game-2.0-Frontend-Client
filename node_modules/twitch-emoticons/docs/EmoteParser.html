...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The template to be used.<br>The strings that can be interpolated are:</p>
<ul>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The type of the parser.<br>Can be one of <code>markdown</code>, <code>html</code>, <code>bbcode</code>, or <code>plain</code>.<br>If the <code>template</code> option is provided, this is ignored.</p></td>
        </tr>
...
<span class="param-type">RegExp</span>
            ...
            <td class="description last"><p>The regular expression that matches an emote.<br>Must be a global regex, with one capture group for the emote code.</p></td>
        </tr>
